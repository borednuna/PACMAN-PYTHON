...
# Inherit Inky from Ghost
class Inky(Ghost):
    img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/blue.png'), (45, 45))
    spooked_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/powerup.png'), (45, 45))
    dead_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/dead.png'), (45, 45))

    # constructor
    def __init__(self, target, id):
        super().__init__(440, 388, target, 2, id)
        self.img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/blue.png'), (45, 45))
        self.rect = self.draw()

    # draw ghost
    def draw(self, screen, spooked_img, dead_img):
